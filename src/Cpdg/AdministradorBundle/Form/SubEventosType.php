...
class SubEventosType extends AbstractType
{
    /**
    ...
    {
        $builder
            ->add('idEvento', EntityType::class, array(
                'class' => 'CpdgAdministradorBundle:Eventos',
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Cpdg\AdministradorBundle\Entity\SubEventos'
        ));
    }
}
