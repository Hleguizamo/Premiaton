...
use Cpdg\AdministradorBundle\Entity\Departamentos;
use Cpdg\AdministradorBundle\Form\DepartamentosType;
...
class DepartamentosController extends Controller
{
    ...
    public $entityMain = "Departamentos";
    public $titulo = "Departamento";
   ...
   public function indexAction(Request $request)
     ...
     *
     */
    public function editAction(Request $request, Departamentos $postvar)
    {
        //-------------------------------------
        $useridObj = $this->get('security.token_storage')->getToken()->getUser('Article', 1);
        $usertype=$useridObj->getSuperadmin();
     ...
     *
     */
    public function deleteAction(Request $request, Departamentos $administrador)
    {
        //-------------------------------------
        $useridObj = $this->get('security.token_storage')->getToken()->getUser('Article', 1);
        $usertype=$useridObj->getSuperadmin();
