...
use Cpdg\AdministradorBundle\Form\AdministradorRegionalType;

/**
 * AdministradorRegional controller.
 *
 */
class AdministradorRegionalController extends Controller
{
   public $baseBundle = "CpdgAdministradorBundle";
   public $entityMain = "Administrador";
   public $titulo = "Administradores Regionales";
   ...
   public function indexAction(Request $request)
    {
        ...
        $consulta->andWhere('e.superadmin = :superadmin')->setParameter('superadmin', '0');
        //----------------------------------
        ...
        return $this->render('CpdgAdministradorBundle:Templates:indexbase.html.twig', array(
            'titulo' => $this->titulo,
            'namevar' => strtolower('administradorregional'),
    ...
    public function newAction(Request $request)
        ...
        $form = $this->createForm("Cpdg\AdministradorBundle\Form\AdministradorRegionalType", $newf);        
        $form->handleRequest($request);
        if ($form->isSubmitted() && $form->isValid()) {                    
            $em = $this->getDoctrine()->getManager();
            $newf->setPublic(1); 

            $newf->setSuperadmin(0); 

            $newf->setSuperadministrador(0); 
            $newf->setMenuEventos(0);
            $newf->setMenuAsociados(0);
            $newf->setMenuProveedores(0);
            $newf->setMenuAdministradores(0);
            $newf->setMenuEventosinternos(0);
            $newf->setMenuRegistro(0);
            ...
            return $this->redirectToRoute(strtolower($this->entityMain).'regional_index');
        }
    ...
    public function editAction(Request $request, Administrador $postvar)
    {
        ...
        $editForm = $this->createForm("Cpdg\AdministradorBundle\Form\AdministradorRegionalType", $postvar);
    ...
    public function updateContrasenaAction(Request $request, Administrador $postvar)
    {
        ...
        $editForm = $this->createForm("Cpdg\AdministradorBundle\Form\AdministradorcontrasenaType", $postvar);
        $editForm->handleRequest($request);
